package com.ruayou.core.context.response;

import com.fasterxml.jackson.databind.node.ObjectNode;
import com.ruayou.common.enums.ResponseCode;
import com.ruayou.common.utils.JSONUtil;
...
public class GatewayResponse {
    ...
    public  static GatewayResponse buildGatewayResponse(ResponseCode code, Object...args){
        ...
        objectNode.put(ResponseCode.STATUS,code.getStatus().code());
        objectNode.put(ResponseCode.CODE,code.getCode());
        objectNode.put(ResponseCode.MESSAGE,code.getMessage());
    ...
    public  static GatewayResponse buildGatewayResponse(Object data){
        ObjectNode objectNode = JSONUtil.createObjectNode();
        objectNode.put(ResponseCode.STATUS,ResponseCode.SUCCESS.getStatus().code());
        objectNode.put(ResponseCode.CODE,ResponseCode.SUCCESS.getCode());
        objectNode.putPOJO(ResponseCode.DATA,data);
