package com.ruayou.core.context.request;
...
public class GatewayRequest implements IGatewayRequest{
    ...
    public GatewayRequest(Charset charset, String clientIp, String host, String uri, HttpMethod method, String contentType, HttpHeaders headers, FullHttpRequest fullHttpRequest) {
        ...
        this.modifyScheme = CommonConst.HTTP_PREFIX_SEPARATOR;
    ...
    public List<String> getPostParametersMultiples(String name){
        ...
        if(isFormPost()){
            ...
            try {
                return Lists.newArrayList(JSON.parseObject(body).getString(name));
            }catch (Exception e){
                log.error("Json获取参数解析失败:{},Body:{},",name,body,e);
            }
        }
        return null;
    }
