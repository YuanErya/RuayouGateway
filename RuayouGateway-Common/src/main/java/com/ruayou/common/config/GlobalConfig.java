...
public class GlobalConfig implements Config {
    ...
    private static RegisterAndConfigCenterConfig registerAndConfigCenterConfig;
    ...
    public static GlobalConfig getConfig() {
        if (INSTANCE == null) {
            ...
            try {
                ...
                RegisterAndConfigCenterConfig rcConfig = YamlUtils.parseYaml(inputStream, RegisterAndConfigCenterConfig.class);
                if (rcConfig != null) {
                    registerAndConfigCenterConfig = rcConfig;
                    log.info("Load register center connection info success from config：{}", rcConfig);
                }
    ...
    public RegisterAndConfigCenterConfig getRegisterAndConfigCenterConfig() {
        return registerAndConfigCenterConfig;
    }
}
